...
type HandleDeleteTodoFunction = (id: string) => void;
...
interface TodoItemProps {
  ...
  handleToggleDone: (index: string) => void;
}
...
export default function TodoItem({
  ...
  function handleDelete(event: MouseEvent<HTMLAnchorElement>) {
  ...
  return (
    <li className="mb-2 flex flex-row justify-between">
      ...
      <Link href="#" onClick={handleDelete} className="inline text-red-500">
        <svg
